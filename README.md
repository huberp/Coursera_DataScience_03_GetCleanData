...
1. with the found "col-classes and names" vector we load data for &lt;dataset&gt; in {"train", "test"}, see function "loadJoinedDataSet"
	...
	* the file &lt;basedir&gt;/&lt;dataset&gt;/y_&lt;dataset&gt;.txt - add is as factor column using &lt;basedir&gt;/activities.txt to create the factor; column name "activities"
